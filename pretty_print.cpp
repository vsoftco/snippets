// Recursively print of STL-like containers of containers of ...
...
template<class T>
void pretty_print(const T& arg, std::string delim,
...
void pretty_print(const Cont<T, Alloc>& arg,
                  std::string delim = " ",
                  std::string left_separator = "[",
                  std::string right_separator = "]",
